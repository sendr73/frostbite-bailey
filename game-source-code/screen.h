...
public:
    ...
    *  The input of the title, title colour and message is inputted into the function.
    *  The window parameter is passed in so the Message Screen members can be drawn.
    *
    ...
    *
    * This calls the private helper function defined in the Screen Class and the public
