...
splashScreen::splashScreen(const float gameWidth, const float gameHeight)
{
    ...
    paragraph.setString("Use the LEFT and RIGHT arrow keys to move Frostbite left and right \n"
                        ...
                        "Try to land on the moving icebergs to build the igloo. \n"
                        "Beware of the crabs and clams and do not fall in the water\n"
                        "as you will loose a life. \n"
                        "If the temperature decreases below zero you will freeze. \n"
                        "To win build and enter the igloo before your lives run out. \n \n"
